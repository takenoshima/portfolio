...
<head>
  ...
  <meta name="description" content="モデルハウスで体感する理想の住まい">
  <title>モデルハウス｜株式会社サンプルホーム</title>
...
<body>
  ...
  <main>
    <section class="c-page-hero" style="background-image: url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1920&q=80');">
      <div class="page-hero__content">
        <span class="en">Model House</span>
        <h1 class="ja">モデルハウス</h1>
      </div>
    </section>
    <nav class="c-breadcrumb">
      <div class="l-container">
        <a href="../index.php">ホーム</a><span>›</span><span>モデルハウス</span>
      </div>
    </nav>
    <section class="l-section">
      <div class="l-container">
        <div class="p-modelhouse__grid">
          <a href="detail.php" class="c-card js-scroll">
            <div class="c-card__image">
              <span class="status-badge">常時公開中</span>
              <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&q=80" alt="世田谷モデルハウス">
            </div>
            <div class="c-card__body">
              <h3 class="c-card__title">世田谷モデルハウス</h3>
              <ul class="info-list">
                <li><span class="label">所在地：</span>東京都世田谷区○○1-2-3</li>
                <li><span class="label">商品：</span>NATURAL LINE</li>
                <li><span class="label">延床面積：</span>35坪</li>
              </ul>
            </div>
          </a>
          <a href="detail.php" class="c-card js-scroll">
            <div class="c-card__image">
              <span class="status-badge" style="background:#c8a96e;">完全予約制</span>
              <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&q=80" alt="横浜モデルハウス">
            </div>
            <div class="c-card__body">
              <h3 class="c-card__title">横浜みなとみらいモデルハウス</h3>
              <ul class="info-list">
                <li><span class="label">所在地：</span>神奈川県横浜市○○2-3-4</li>
                <li><span class="label">商品：</span>PREMIUM LINE</li>
                <li><span class="label">延床面積：</span>40坪</li>
              </ul>
            </div>
          </a>
          <a href="detail.php" class="c-card js-scroll">
            <div class="c-card__image">
              <span class="status-badge">常時公開中</span>
              <img src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=600&q=80" alt="さいたまモデルハウス">
            </div>
            <div class="c-card__body">
              <h3 class="c-card__title">さいたま新都心モデルハウス</h3>
              <ul class="info-list">
                <li><span class="label">所在地：</span>埼玉県さいたま市○○3-4-5</li>
                <li><span class="label">商品：</span>HIRAYA LINE</li>
                <li><span class="label">延床面積：</span>30坪</li>
              </ul>
            </div>
          </a>
        </div>
